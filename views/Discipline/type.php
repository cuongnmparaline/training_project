                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="disciplineTypeCode" value="<?=generateCode('disciplineType')?>" readonly>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <!-- /.form-group -->
                                    <button type='submit' class='btn btn-primary' name='taoLoai'><i class='fa fa-plus'></i> Tạo loại kỷ luật</button>
                                </div>
                                <!-- /.col -->
                            </div>
                            <!-- /.row -->
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            foreach ($types as $type)
                            {
                                ...
                                <tr>
                                    ...
                                    <th>
                                        <a href="ky-luat/sua-loai/<?=$type['id']?>" class='btn bg-orange btn-flat'><i class='fa fa-edit'></i></a>
                                    </th>
                                    <th>
                                        <button type='button' class='btn bg-maroon btn-flat' data-toggle='modal' data-target='#exampleModal' data-whatever="ky-luat/xoa-loai/<?=$type['id']?>"><i class='fa fa-trash'></i></button>
                                    </th>
                                </tr>
                                <?php
                                $count++;
