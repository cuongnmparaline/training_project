                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    foreach ($salaries as $salary)
                                    {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo number_format($salary['luong_ngay'])."vnđ"; ?></td>
                                            <td><?php echo $salary['ngay_cong']; ?></td>
                                            <td><?php echo number_format($salary['luong_thang'])."vnđ"; ?></td>
                                            <td><?php echo number_format($salary['phu_cap'])."vnđ"; ?></td>
                                            <td style="color: red; font-weight: bold;"><?php echo number_format($salary['khoan_nop'])."vnđ"; ?></td>
                                            <td><?php echo number_format($salary['tam_ung'])."vnđ"; ?></td>
